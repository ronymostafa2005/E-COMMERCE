          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      Schedule a meeting with our team to discuss your marketing
                      needs and goals.
                    </span>
                  </Fragment>
                )}
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      Our team will execute the marketing plan and continuously
                      monitor its performance for optimization.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container7 thq-card">
              <h2 className="thq-heading-2">
                {props.step4Title ?? (
                  <Fragment>
                    <span className="steps2-text32">Results and Analysis</span>
                  </Fragment>
                )}
              </h2>
